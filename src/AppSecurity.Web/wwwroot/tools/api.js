window.AppSecurityApi = {
    tokenKey: "appSecurityAuthToken",
    token: null,
    currentUser: null,
    ...
    send: async function (method, path, data) {
        const options = {
            method: method,
            headers: {
...
document.addEventListener("DOMContentLoaded", () => window.AppSecurityApi.init());
